...
@WebMvcTest({AuthController.class, AdminController.class, UserController.class})
...
public class AuthControllerTest {
    ...
    void rootWhenUnauthenticatedThen403() throws Exception {
        ...
        this.mvc.perform(post("/api/v1/auth/")
    ...
    @Test
    void rootWhenAuthenticatedThenAdmin() throws Exception {
        LoginRequestDTO loginRequestDTO = LoginRequestDTO.builder()
                .username("admin")
                .password("password")
                .build();
    ...
    @Test
    void rootWhenAuthenticatedThenUser() throws Exception {
        LoginRequestDTO loginRequestDTO = LoginRequestDTO.builder()
                .username("user")
                .password("password")
                .build();
        ...
        this.mvc.perform(get("/api/v1/user")
                .header(HttpHeaders.AUTHORIZATION, "Bearer " + loginResponseDTO.getToken()))
                .andExpect(content().string("User Hello, user"));
    }
